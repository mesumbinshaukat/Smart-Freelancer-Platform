...
if (isset($_SESSION["checking"]) && !empty($_SESSION["checking"])) {
                    ...
                    <div class="account-wrapper text-center">
                        ...
                        <form method="post" class="vstack gap-4">
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit" class="btn btn-primary-dark w-full py-4">Sign
                                    In</button>
                            </div>
                            <div class="text-center">
                                <p>Don't have an account? <a
                                        href="http://localhost:8080/Smart-Freelancer-Platform/register.php"

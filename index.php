                        ...
                        <div class="col-lg-9">
                            <div class="text-center">
                                <div class="position-relative z-1">
                                    ...
                                    <h1 class="text-white mb-8" data-aos="fade-up-sm" data-aos-delay="150">
                                        ...
                                        <span class="fw-bold text-gradient-2 typed-animation"
                                            data-strings='["Lower Fees", "Security", "Transparency"]'>Transparency</span>
                                    </h1>
                                    <a href="login.html" class="btn btn-lg btn-gradient-1" data-aos="fade-up-sm"
                                        data-aos-delay="200">Start Earning - It's Easy Now</a>
                                </div>
                                ...
                                <ul
                                    ...
                                    <li>Get your work 10X Faster</li>
                                    <li>Find High Converting Clients</li>
                                    <li>Find More Potential Work</li>
                                </ul>
                ...
                <div class="container">
                    <div class="text-center mb-18">
                        <h1 class="mb-0 text-white" data-aos="fade-up-sm" data-aos-delay="50">
                            World's First Smart Contract Freelance Platform
                        </h1>
                    </div>
                    ...
                    <div class="row g-6 g-xl-14">
                        <div class="col-lg-4" data-aos="fade-up-sm" data-aos-delay="200">
                            <div class="d-flex flex-column gap-6 flex-lg-row">
                                ...
                                <div class="content">
                                    <h4 class="mb-4 text-white">Find quality Content Creators</h4>
                                    <p>
                                        This platform helps you find the right talent to target for your content. By
                                        working with Freelancers, you can see amamzing performance.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4" data-aos="fade-up-sm" data-aos-delay="250">
                            <div class="d-flex flex-column gap-6 flex-lg-row">
                                ...
                                <div class="content">
                                    ...
                                    <p>
                                        Smart Contractors can analyze data and generate insights to help users
                                        create more
                        ...
                        <div class="col-lg-4" data-aos="fade-up-sm" data-aos-delay="300">
                            <div class="d-flex flex-column gap-6 flex-lg-row">
                                ...
                                <div class="content">
                                    <h4 class="mb-4 text-white">Improves Work Experience</h4>
                                    <p>
                    ...
                    <div class="text-center mt-12">
                        <a href="login.html" class="btn btn-primary-dark">Try Now</a>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row g-6 gx-lg-14 gx-xl-20 align-center">
                        <div class="col-lg-6" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="content">
                                ...
                                <p class="mb-6">
                                    Our platform uses smart contracts to ensure funds are securely held and only
                                    released when both parties are satisfied with the work, guaranteeing peace of mind.
                                </p>
                                <ul class="list-unstyled list-check mb-8">
                                    <li>
                                        ...
                                        <span>Secure fund holding with smart contracts</span>
                                    </li>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"
                                            class="icon">
                                        ...
                                        <span>Funds released only upon job completion</span>
                                    </li>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"
                                            class="icon">
                                        ...
                                        <span>Full transparency in transactions</span>
                                    </li>
                                </ul>
                    ...
                    <div class="row g-6 gx-lg-14 gx-xl-20 align-center mt-10 flex-row-reverse">
                        <div class="col-lg-6 col-xl-6" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="content">
                                ...
                                <p class="mb-6">
                                    Enjoy the benefits of lower fees compared to traditional freelance platforms,
                                    putting more money in your pocket. Fast and secure payments guaranteed by blockchain
                                    technology.
                                </p>
                                <ul class="list-unstyled list-check mb-8">
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <span>Secure and fast payments without intermediaries</span>
                                    </li>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"
                                            class="icon">
                                        ...
                                        <span>Enhanced financial control and flexibility</span>
                                    </li>
                                </ul>
                                <a href="login.html" class="arrow-link arrow-link-primary-dark text-primary-dark gap-3">
                    ...
                    <div class="row g-6 gx-lg-14 gx-xl-20 align-center mt-10">
                        <div class="col-lg-6" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="content">
                                ...
                                <h1 class="text-white mb-8">
                                    Transparent Reviews and Global Opportunities
                                </h1>
                                <p class="mb-6">
                                    Our decentralized review system ensures fair and unbiased feedback, helping you make
                                    informed decisions. Connect with clients and freelancers from around the world to
                                ...
                                <ul class="list-unstyled list-check mb-8">
                                    <li>
                                        ...
                                        <span>Fair and unbiased feedback system</span>
                                    </li>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"
                                            class="icon">
                                        ...
                                        <span>Connect globally with clients and freelancers</span>
                                    </li>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18"
                                            class="icon">
                                        ...
                                        <span>Expand your reach and opportunities</span>
                                    </li>
                                </ul>
                                <a href="login.html" class="arrow-link arrow-link-primary-dark text-primary-dark gap-3">
                                    <span>Get Started Free</span>
                        ...
                        <div class="col-lg-9">
                            <div class="text-center">
                                <p class="text-primary-dark" data-aos="fade-up-sm" data-aos-delay="50">
                                    Smart Contractors Use Cases
                                </p>
                                <h1 class="text-white mb-0" data-aos="fade-up-sm" data-aos-delay="100">
                                    Find Better Content Faster, The Future Of Freelancers is Here
                                </h1>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-center row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 gx-8 gy-14">
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="use-cases-details.html"
                                        class="arrow-link arrow-link-primary-dark gap-3 fs-sm">
                        ...
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="250">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="content flex-grow-1">
                                    <h5 class="text-white mb-4">Website Development</h5>
                                    <p class="mb-0">
                        ...
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="300">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="content flex-grow-1">
                                    <h5 class="text-white mb-4">Social Media Marketing</h5>
                                    <p class="mb-0">
                        ...
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="content flex-grow-1">
                                    <h5 class="text-white mb-4">Landing Pages</h5>
                                    <p class="mb-0">
                                        First know who you're targeting. Identify your target audience and understand
                                        their needs.
                                    </p>
                        ...
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="250">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="content flex-grow-1">
                                    <h5 class="text-white mb-4">eCommerce store builder</h5>
                                    <p class="mb-0">
                        ...
                        <div class="col" data-aos="fade-up-sm" data-aos-delay="300">
                            <div class="d-flex flex-column justify-between gap-6 h-full">
                                ...
                                <div class="content flex-grow-1">
                                    <h5 class="text-white mb-4">Digital Products</h5>
                                    <p class="mb-0">
                                        Optimize you content for the first know who you're targeting. Identify your
                                        target audience.
                                    </p>
                        ...
                        <div class="col-lg-9">
                            <div class="text-center">
                                <h1 class="text-white" data-aos="fade-up-sm" data-aos-delay="50">
                                    <span class="text-primary-dark">Smart Contractors.</span>
                    ...
                    <div class="row g-6 pricing-table">
                        <div class="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="50">
                            <div class="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                ...
                                <a href="pricing-plan.html"
                                    class="pricing-btn btn btn-lg w-full fs-4 lh-sm mt-9 btn-dark-blue-3">Start for
                                    Free</a>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="100">
                            <div class="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                ...
                                <h1 class="display-2 fw-semibold text-white mb-0 mt-4">$29</h1>
                                <p class="text-white lead fw-normal mt-4 mb-0">
                                    A 10X faster way to writing your professional copy
                                </p>
                                <a href="pricing-plan.html"
                                    class="pricing-btn btn btn-lg w-full fs-4 lh-sm mt-9 btn-dark-blue-3">Choose
                                    Plan</a>
                                <ul class="pricing-list d-flex flex-column gap-5 fs-lg mt-9 mb-0">
                                    <li>5 User seats</li>
                                    <li>
                                        <strong class="text-white fw-medium">50,000</strong> words per month
                                    </li>
                                    <li><strong class="text-white fw-medium">70+</strong> AI writing tools</li>
                                    <li>
                                        <strong class="text-white fw-medium">100+</strong> Copywriting tools
                                    </li>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="150">
                            <div class="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                ...
                                <h1 class="display-2 fw-semibold text-white mb-0 mt-4">$119</h1>
                                <p class="text-white lead fw-normal mt-4 mb-0">
                                    A 10X faster way to writing your professional copy
                                </p>
                                <a href="pricing-plan.html"
                                ...
                                <ul class="pricing-list d-flex flex-column gap-5 fs-lg mt-9 mb-0">
                                    ...
                                    <li>
                                        <strong class="text-white fw-medium">200+</strong> Copywriting tools
                                    </li>
                                    <li>Blog post wizard tool</li>
                                    <li>25+ languages</li>
                                </ul>
                ...
                <div class="container">
                    <div class="row justify-center mb-18">
                        <div class="col-lg-10">
                            <div class="text-center">
                                <h1 class="mb-0 text-white" data-aos="fade-up-sm" data-aos-delay="50">
                                    Questions About Smart Contractors? <br class="d-none d-md-block" />
                                    We have Answers!
                                </h1>
                            </div>
                        </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <span class="icon"></span>
                                            Is there a limit on how much projects I can write?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <span class="icon"></span>
                                            What is Smart Contractors and how do I use it?
                                        </button>
                                    </h2>
                            ...
                            <div class="col-lg-10">
                                <div class="text-center pt-6 px-6 pt-md-10 px-md-10 pt-lg-18 px-lg-18">
                                    <h2 class="mb-6 text-white">
                                        Using
                                        <span class="text-primary-dark">Smart Contractors</span>
                                        you can save hours each week find best Freelancers to do it for you.
                                    </h2>

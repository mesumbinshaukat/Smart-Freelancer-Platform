<div class="sidebar-wrapper" data-simplebar="true">
  ...
  <ul class="metismenu" id="menu">
    ...
    <li>
      <a href="find-projects.php">
        <div class="parent-icon"><i class='bx bx-file-find'></i>
        </div>
        <div class="menu-title">Find Project</div>
      </a>
    </li>
    <li>
      ...
      <ul>
        <li> <a href="add-project.php"><i class='bx bx-radio-circle'></i>Add Project</a>
        </li>
        <li> <a href="edit-project.php"><i class='bx bx-radio-circle'></i>Edit Project</a>
        </li>
        <li> <a href="delete-project.php"><i class='bx bx-radio-circle'></i>Delete Project</a>
        </li>
        <li> <a href="view-project.php"><i class='bx bx-radio-circle'></i>View Projects</a>
        </li>

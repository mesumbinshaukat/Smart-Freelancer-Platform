                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td><button class='btn btn-light' data-bs-toggle='modal' data-bs-target='#chatModal' onclick='initChat(" . json_encode($row['creator_id']) . ", " . json_encode($row['bidder_id']) . ")'><i class='bx bx-message-dots'></i></button></td>";
                      echo "</tr>";
                    }
                  } else {
